  ...
  return (
    <div className="grid min-h-screen bg-muted p-6 md:place-items-center">      
      <div className="mx-auto w-full max-w-xl ">
        <Image src="/logo_gkx_white.webp" alt="GKX Logo" width={96} height={52} className="mx-auto rounded-2xl border border-border p-2" />
        <div className="mt-2 rounded-2xl border border-border bg-card p-7 shadow-sm">
          <h1 className="mt-2 text-2xl font-semibold text-card-foreground text-center">Crea tu cuenta</h1>
          <p className="mt-1 text-sm text-muted-foreground text-center">Crea tu tenant y usuario administrador inicial.</p>

          <form className="mt-6 grid gap-4 md:grid-cols-2" onSubmit={form.handleSubmit(onSubmit)}>
            <label className="block space-y-1 md:col-span-2">
              <span className="text-sm text-foreground">Nombre de organización</span>
